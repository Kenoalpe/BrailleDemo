...
class SampleBase(object):
    ...
    def DrawBox(self,canvas,x0,y0,x1,y1,r,g,b):
        graphics.DrawLine(canvas, x0, y0, x1, y0, graphics.Color(r,g,b))
        graphics.DrawLine(canvas, x1, y0, x1, y1, graphics.Color(r,g,b))
        graphics.DrawLine(canvas, x1, y1, x0, y1, graphics.Color(r,g,b))
        graphics.DrawLine(canvas, x0, y1, x0, y0, graphics.Color(r,g,b))
    
    def FillBox(self,canvas,x0,y0,x1,y1):
        for i in range(y0,y1+1):
            graphics.DrawLine(canvas, x0, i, x1, i, graphics.Color(200,200,200))
